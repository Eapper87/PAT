  ...
  const plans = [
    {
      ...
      price: 0,
              credits: 3,
              features: ['3 free credits', 'Basic AI agents', 'Email support'],
      popular: false,
      priceId: null
    },
    {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-white text-center mb-8">Fantasy Subscription Plans</h2>
      ...
      {/* Credit Packages */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-white text-center mb-8">Pay-Per-Minute Fantasy Packages</h2>
      ...
      <section className="max-w-4xl mx-auto">
        <h2 className="text-2xl font-semibold text-white text-center mb-8">Fantasy FAQ</h2>
        <div className="space-y-6">
          {[
            {
              question: 'How do credits work?',
              answer: 'Each credit allows you to make one intimate AI conversation. Sessions are billed per minute, with 1 credit = 1 minute of fantasy time.'
            },
            {
            ...
            },
            {
              ...
              answer: 'You can purchase additional credit packages or upgrade to a subscription plan to continue your intimate conversations.'
            },
            {
      ...
      >
        <div className="glass-card p-8 max-w-2xl mx-auto">
                  <h2 className="text-2xl font-bold text-white mb-4">Ready to Start Your Fantasy?</h2>
        <p className="text-gray-400 mb-6">
          Join thousands of users already experiencing the future of AI adult entertainment
        </p>
