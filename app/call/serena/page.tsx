...
export default function SerenaPage() {
  ...
  const checkUser = async () => {
    try {
      ...
      setTimeout(() => {
        ...
        addSerenaMessage("Mmm, hello there, handsome... 💋 I'm Serena, and I can see the desire burning in your eyes. I'm here to fulfill your wildest fantasies. What's on your mind tonight?")
      }, 2000)
  ...
  const addSerenaMessage = (message: string) => {
    setConversation(prev => [...prev, `💋 Serena: ${message}`])
  }
  ...
  const generateSerenaResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('hot') || lowerMessage.includes('sexy') || lowerMessage.includes('passion')) {
      return "🔥 Oh yes, I love a man who knows what he wants... You want it hot and steamy, don't you? I can feel your desire from here. Tell me more about what makes you burn inside..."
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto mb-6">
            ...
            {isTyping && (
              <div className="p-4 rounded-lg bg-neon-pink/20 border border-neon-pink/40">
                <span className="text-gray-300">💋 Serena is typing...</span>
              </div>
            )}
          </div>
